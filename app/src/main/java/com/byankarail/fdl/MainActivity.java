...
public class MainActivity extends Activity {
    private static final String PREFS = "fdl_updater";
    ...
    private void setupWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                if ("fdl.local".equalsIgnoreCase(u.getHost()) && "/game.html".equals(u.getPath())) {
                    try {
    ...
    private void loadGame() {
        webView.loadUrl("https://fdl.local/game.html");
    }

    private void injectDownloadBridge() {
        String js = "(function(){" +
                "if(window.__FDL_ANDROID_DL)return;window.__FDL_ANDROID_DL=1;" +
                ...
                "AndroidBridge.saveBase64(a.download||'FIRE_DIRECTION_LAB_export.bin',b.type||'application/octet-stream',p>=0?x.substring(p+1):'');" +
    ...
    private void checkForUpdates(boolean manual) {
        io.execute(() -> {
            try {
                ...
                c.setRequestProperty("User-Agent", "FDL-Android-Updater/1.0");
    ...
    private void showAppMenu() {
        ...
        new AlertDialog.Builder(this)
                .setTitle("FIRE DIRECTION LAB · " + ver)
            ...
            io.execute(() -> {
                try {
                    ...
                    runOnUiThread(() -> Toast.makeText(MainActivity.this,
                            "다운로드/FIRE_DIRECTION_LAB에 저장했습니다.", Toast.LENGTH_LONG).show());
                } catch (Exception e) {
                    runOnUiThread(() -> Toast.makeText(MainActivity.this,
    ...
    private void saveToDownloads(String filename, String mime, byte[] data) throws Exception {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            values.put(MediaStore.Downloads.RELATIVE_PATH, Environment.DIRECTORY_DOWNLOADS + "/FIRE_DIRECTION_LAB");
            ...
            File dir = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "FIRE_DIRECTION_LAB");
    ...
    private static String sanitizeFilename(String s) {
        String x = (s == null || s.trim().isEmpty()) ? "FIRE_DIRECTION_LAB_export.bin" : s.trim();
